 ...
 * @version 1.0
 *
 * This class will represent the value of an ingredient for a pizza. Namely, "Mozzarella" cheese. It will not be able
 ...
 * when called, invoke the ingredient classes constructor and set the "Mozzarella" ingredients private name, cost and
 * calorie count.
 */
public class Mozzarella extends Cheese {
    /**
     * This is the no-args constructor for the Mozzarella class.
     *
     ...
     */
    public Mozzarella() {
        super("Mozzarella", new Money(2,25), 150);
    }
}
