 ...
 * @version 1.0
 *
 * This class will represent the value of an ingredient for a pizza. Namely, "Pepper" vegetable. It will not be able
 ...
 * when called, invoke the ingredient classes constructor and set the "Pepper" ingredients private name, cost and
 * calorie count.
 */
public class Pepper extends Vegetable {
    /**
     * This is the no-args constructor for the Pepper class
     *
     ...
     */
    public Pepper() {
        super("Pepper", new Money(3,50), 90, new Color(0,128,0));
    }
}
